...
class OnlineSalesRegisterCollector:
    ...
    def twenty_percent_tax_calculation(self):
        ...
        base_tax_sum = sum(total) * 0.2
        
        if self.__number_items > 10:
            return base_tax_sum * 0.9
        return base_tax_sum
...
print("Товары:", register.name_items)
print("Сумма:", register.check_amount())
print("Налог:", register.total_tax())